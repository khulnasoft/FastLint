...
import fastlint.fastlint_interfaces.fastlint_metrics as met
import fastlint.fastlint_interfaces.fastlint_output_v1 as out
from fastlint import __VERSION__
from fastlint.constants import USER_FRIENDLY_PRODUCT_NAMES
from fastlint.error import error_type_string
...
from fastlint.fastlint_interfaces.fastlint_metrics import AnalysisType
from fastlint.fastlint_interfaces.fastlint_metrics import CodeConfig
from fastlint.fastlint_interfaces.fastlint_metrics import Datetime
from fastlint.fastlint_interfaces.fastlint_metrics import EngineConfig
from fastlint.fastlint_interfaces.fastlint_metrics import Environment
from fastlint.fastlint_interfaces.fastlint_metrics import Errors
from fastlint.fastlint_interfaces.fastlint_metrics import Extension
from fastlint.fastlint_interfaces.fastlint_metrics import FileStats
from fastlint.fastlint_interfaces.fastlint_metrics import Interfile
from fastlint.fastlint_interfaces.fastlint_metrics import Interprocedural
from fastlint.fastlint_interfaces.fastlint_metrics import Intraprocedural
from fastlint.fastlint_interfaces.fastlint_metrics import ParseStat
from fastlint.fastlint_interfaces.fastlint_metrics import Payload
from fastlint.fastlint_interfaces.fastlint_metrics import Performance
from fastlint.fastlint_interfaces.fastlint_metrics import ProFeatures
from fastlint.fastlint_interfaces.fastlint_metrics import RuleStats
...
from fastlint.fastlint_interfaces.fastlint_metrics import Value
from fastlint.fastlint_types import get_frozen_id
from fastlint.types import FilteredMatches
...
METRICS_ENDPOINT = "https://metrics.fastlint.dev"
...
class Metrics:
    ...
    # currently an enum. Ideally it would be more like ofastlint's Engine_type.t,
    ...
    def add_engine_config(
        ...
        """
        Assumes configs is list of arguments passed to fastlint using --config
        """
    ...
    @suppress_errors
    def add_errors(self, errors: List[FastlintError]) -> None:
    ...
    def is_enabled(self) -> bool:
        ...
        if self.metrics_state == MetricsState.AUTO:
            # When running logged in with `fastlint ci`, configs are
    ...
    def _post_metrics(self, *, user_agent: str, local_scan_id: str) -> None:
        ...
        # alt: save it in ~/.fastlint/logs/metrics.json?
        ...
        r = requests.post(
            ...
            headers={
                ...
                "X-Fastlint-Scan-ID": local_scan_id,
            },
            timeout=3,
        )
    ...
    def send(self) -> None:
        ...
        from fastlint.state import get_state  # avoiding circular import
