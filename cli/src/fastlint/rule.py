...
from fastlint.rule_lang import RuleValidation
...
from fastlint.fastlint_types import Language
from fastlint.fastlint_types import SEARCH_MODE
...
class Rule:
    ...
    def is_blocking(self) -> bool:
        ...
        validation_state_metadata = self.metadata.get(
            "dev.fastlint.validation_state.actions"
        )
    ...
    def full_hash(self) -> str:
        ...
        We remove metadata cause it can contain user-specific data when connected to Fastlint App.
        """
    ...
    @property
    def should_run_on_fastlint_core(self) -> bool:
        """
