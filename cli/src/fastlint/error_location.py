...
# ...
# E           attr.exceptions.NotAnAttrsClassError: <class 'fastlint.fastlint_interfaces.fastlint_output_v1.Position'> is not an attrs-decorated class.
#
...
class Position:
    ...
    line & column are 1-indexed for compatibility with fastlint-core which also produces 1-indexed results
    """
