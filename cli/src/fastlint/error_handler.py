...
class ErrorHandler:
    ...
    def send(self, exit_code: int) -> int:
        ...
        from fastlint.app import auth  # avoiding circular import
        ...
        logger.error(
            "There were errors during analysis but Fastlint will succeed because there were no blocking findings, use --no-suppress-errors if you want Fastlint to fail when there are errors."
        )
