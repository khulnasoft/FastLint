...
ID_KEY = "id"
CLI_RULE_ID = "-"
PLEASE_FILE_ISSUE_TEXT = "An error occurred while invoking the Fastlint engine. Please help us fix this by creating an issue at https://github.com/khulnasoft/fastlint"

DEFAULT_FASTLINT_APP_CONFIG_URL = "api/agent/deployments/scans/config"
...
KHULNASOFT_LEVER_URL = "https://api.lever.co/v0/postings/khulnasoft?mode=json"
...
# ' nosem'
# ' nofastlint: example-pattern-id'
# ' nosem: pattern-id1,pattern-id2'
# ' NOFASTLINT:pattern-id1,pattern-id2'
#
...
# A nofastlint comment alone on its line.
...
# Must be kept in sync w/ ofastlint
