...
from fastlint.util import manually_search_file
        ...
        raise FastlintError(
            dedent(
                ...
                - the baseline commit is not a parent of the current commit
                    (if you are running through fastlint-app, check if you are setting `FASTLINT_BRANCH` or `FASTLINT_BASELINE_COMMIT` properly)
...
class BaselineHandler:
    ...
    def _get_git_status(self) -> GitStatus:
        ...
        while status_output:
            ...
            # and they're needed to track fastlint findings in spite of file renames.
    ...
    def _remove_worktree_with_check(self, worktree_dir: str) -> None:
        ...
        # nofastlint: use-git-check-output-helper - we should continue when this fails
