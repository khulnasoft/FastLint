...
# See https://fastlint.dev/docs/writing-rules/testing-rules/#testing-autofix
#
# TODO:
...
def test_fixtest_test1_no_json(run_fastlint_in_tmp: RunFastlint, snapshot):
...
@pytest.mark.kinda_slow
def test_fixtest_test1_json(run_fastlint_in_tmp: RunFastlint, snapshot):
...
@pytest.mark.kinda_slow
def test_fixtest_test2_no_json(run_fastlint_in_tmp: RunFastlint, snapshot):
    results, _ = run_fastlint_in_tmp(
        "rules/fixtest/basic_fix.yaml",
...
@pytest.mark.kinda_slow
def test_fixtest_test2_json(run_fastlint_in_tmp: RunFastlint, snapshot):
    stdout, _ = run_fastlint_in_tmp(
        "rules/fixtest/basic_fix.yaml",
        target_name="fixtest/test2.py",
        options=["--test"],
...
def test_fixtest_test3_no_json(run_fastlint_in_tmp: RunFastlint, snapshot):
    results, _ = run_fastlint_in_tmp(
...
@pytest.mark.kinda_slow
def test_fixtest_test3_json(run_fastlint_in_tmp: RunFastlint, snapshot):
    stdout, _ = run_fastlint_in_tmp(
        "rules/fixtest/other_fix.yaml",
        target_name="fixtest/test3.py",
        options=["--test"],
...
@pytest.mark.kinda_slow
@pytest.mark.osemfail
def test_fixtest_test4_no_json(run_fastlint_in_tmp: RunFastlint, snapshot):
...
@pytest.mark.kinda_slow
@pytest.mark.osemfail
def test_fixtest_test4_json(run_fastlint_in_tmp: RunFastlint, snapshot):
    results = run_fastlint_in_tmp(
        "rules/fixtest/other_pattern.yaml",
        target_name="fixtest/test4.py",
        options=["--test"],
...
# TODO? pyfastlint test should really report an error actually when run
# with an inexistent file
@pytest.mark.kinda_slow
@pytest.mark.osemfail
def test_fixtest_test5_no_json(run_fastlint_in_tmp: RunFastlint, snapshot):
    results, _ = run_fastlint_in_tmp(
        "rules/fixtest/basic_fix.yaml",
...
@pytest.mark.kinda_slow
@pytest.mark.osemfail
def test_fixtest_test5_json(run_fastlint_in_tmp: RunFastlint, snapshot):
    stdout, _ = run_fastlint_in_tmp(
        "rules/fixtest/basic_fix.yaml",
        target_name="fixtest/inexistent.py",
        options=["--test"],
...
@pytest.mark.kinda_slow
def test_missing_fixtest_fix_regex(run_fastlint_in_tmp: RunFastlint, snapshot):
    stdout, _ = run_fastlint_in_tmp(
...
# is not supported (e.g., Go); Indeed, with AST-based autofix fastlint-core
# is parsing the fix pattern and then pretty print back the transformed
# pattern, so newlines do not matter.
@pytest.mark.kinda_slow
def test_fix_trailing_newline(run_fastlint_in_tmp: RunFastlint, snapshot):
    stdout, _ = run_fastlint_in_tmp(
