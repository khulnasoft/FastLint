...
def test_exclude_include_verbose_sorted_1(run_fastlint_in_tmp: RunFastlint, snapshot):
...
@pytest.mark.kinda_slow
@pytest.mark.osemfail
def test_exclude_include_verbose_sorted_2(run_fastlint_in_tmp: RunFastlint, snapshot):
    snapshot.assert_match(
        run_fastlint_in_tmp(
            "rules/nosem.yaml",
