...
from fastlint.config_resolver import validate_single_rule
...
def test_default_yaml_type_safe():
    ...
    # nofastlint: python.lang.security.deserialization.avoid-unsafe-ruamel.avoid-unsafe-ruamel
...
def test_invalid_pattern_child():
    ...
    with pytest.raises(InvalidRuleSchemaError):
        ...
        # in Parse_rule.ml to match the behavior for pyfastlint.
