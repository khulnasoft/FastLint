...
REPOS = [
    ...
    Repo(
        ...
        xfail_reason="DevSlop-Pixi/app/public/api-docs/ contains some minified JS files that cause Fastlint to timeout, so the output will contain some errors.",
    ),
    Repo(
    ...
    Repo(
        ...
        xfail_reason="https://github.com/khulnasoft/fastlint/issues/1498",
    ),
    Repo(
